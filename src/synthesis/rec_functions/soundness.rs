use crate::{
    ...
    driver::{
        ...
        smt_proof::{mk_function_encoder_override, SmtVcProveTask},
    },
...
pub fn run_soundness_check(
    ...
    let bvc_task_orig = BoolVcProveTask {
        quant_vc: vc_expr_orig,
        vc: vc_orig_valid.vc,
    };
    let smt_task_orig = SmtVcProveTask::translate(bvc_task_orig, &mut translate_sound);
    ...
    let result_orig = smt_task_orig.no_slice_run_solver(
        options,
    ...
    match result_orig.prove_result {
        ProveResult::Proof => {
