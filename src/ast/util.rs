...
/// Strips `nonneg_cast(arg)` call nodes when `arg` contains no negative
/// numeric literals, i.e. the cast is visually redundant in the solution.
/// Used purely for display; the internal template is unchanged.
